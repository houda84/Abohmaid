...
y_fit = sol[0]+sol[1] * x + sol[2] * x**2 + ol[3] * x**3
...
def plot_fig(x, y):
    ...
    ax.plot(x, y, ls="-", lw=1, color="r", label="Clockwise rotation")
    # ax.scatter(x, y, color="r")
    # ax.plot(x, y, ls=":", lw=1, color="b", label="Counter-clockwise rotation")
